...
export const zh = {
  ...
  'set.overview': '审批总览',
  'set.overviewSub': '顺序：拒绝关键词 → 人工关键词 → 闸门（看不见这次操作）→ 允许关键词 → 审核模型；判定没跑成固定转人工。',
...
export const en = {
  ...
  'set.overviewSub': 'Order: reject keywords → human keywords → the gate (call not visible) → allow keywords → judge model; a judgment that never ran always asks a human.',
